...
//       ],
//       child: BlocProvider(
//         create: (ctx) => DynamicVisualSectionBloc(ctx.read<DynamicRepository>())
//           ..add(LoadDynamicVisualSection(sectionId.toString())),
...
//   @override
//   State<_DynamicVisualSectionPageBody> createState() => _DynamicVisualSectionPageBodyState();
// }
...
//     }
//     for (var question in currentVisualSection.questions) {
