  ...
  Future<void> login() async {
    ...
    if (_usernameController.text.isNotEmpty &&
      ...
      if (loginResult.username!.isNotEmpty && loginResult.accesstype != "web") {
        ...
        // Initialize Couchbase DB for this user's company after successful login
        try {
          final companyId = loginResult.companyidentifer;
          if (companyId != null && companyId.isNotEmpty) {
            ...
            final user = User(
              ...
              accessType: loginResult.accesstype,
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(width: 0.7, color: const Color(0xFFD0D0D0)),
            ),
          ),
